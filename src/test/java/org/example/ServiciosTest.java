...
public class ServiciosTest
{
    ...
    public void CP_001() throws InterruptedException {
        ...
        System.out.println("Ofrecer en el menú principal del portal el módulo “Servicios");
        System.out.println("Pasos para Replicar");
        System.out.println("Paso 1.\t Verificamos la existencia del botón “Servicios”");
        assertTrue(util.elementExists(linkServicios));

        System.out.println("Paso 2.\t Damos clic en el botón “Servicios”");
        util.doCLick(util.searchElement(linkServicios));

        System.out.println("Paso 3.\t La plataforma nos lleva a la vista del menú “Servicios”");
        Thread.sleep(3000);
    ...
    public void CP_002() throws InterruptedException {
        System.out.println("Indicar la navegación en el menú “Servicios” por medio de un cambio visual.");
        System.out.println("Pasos para Replicar");
        System.out.println("Paso 1.\t Verificamos la existencia del botón “Servicios”");
        assertTrue(util.elementExists(linkServicios));

        System.out.println("Paso 2.\t Pasamos el puntero por el link “Servicios");
        Actions action = new Actions(driver);
        WebElement we = util.searchElement(linkServicios);
        action.moveToElement(we).perform();
        System.out.println("Paso 3.\t La plataforma nos permite visualizar la transición de blanco a azul del botón.");
        Thread.sleep(3000);
    ...
    public void CP_003() throws InterruptedException {
        ...
        System.out.println("Ir al encabezado de la página por medio de una acción directa.");
        System.out.println("Pasos para Replicar");
        System.out.println("Paso 1.\t Movemos el scroll como mínimo hasta el servicio Choucair “Capacidades”");
        WebElement we = util.searchElement(divFooter);
        ((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", we);
        Thread.sleep(2000);

        System.out.println("Paso 2.\t El portal activa el icono de la parte inferior derecha.");
        assertTrue(util.elementExists(aGoTop));
        util.doCLick(util.searchElement(aGoTop));
        Thread.sleep(1000);
        JavascriptExecutor executor = (JavascriptExecutor) driver;

        System.out.println("Paso 3.\t Damos clic al icono y la plataforma permite al usuario regresar al encabezado directamente");
    ...
    public void CP_004() throws InterruptedException {
        ...
        System.out.println("Indicar la navegación en el menú “Servicios” por medio de un cambio visual.");
        System.out.println("Pasos para Replicar");
        System.out.println("Paso 1.\t Verificamos la existencia de los accesos directos de los servicios como: “Capacidades”");
        assertTrue(util.elementExists(imgCapacidades));

        System.out.println("Paso 2.\t Pasamos el puntero por el icono 'Capacidades'");
        WebElement we = util.searchElement(imgCapacidades);
        Actions action = new Actions(driver);
        action.moveToElement(we).perform();
        System.out.println("Paso 3.\t El icono capacidades realiza una transición de Zoom.");
        Thread.sleep(3000);
    ...
    public void CP_006() throws InterruptedException {
        ...
        System.out.println("Navegar en el portal por medio de los iconos de acceso directo");
        System.out.println("Pasos para Replicar");
        System.out.println("Paso 1.\t Damos clic en el icono “Capacidades”");
        assertTrue(util.elementExists(imgCapacidades));
        JavascriptExecutor executor = (JavascriptExecutor) driver;
        long scrollActual=  (long) executor.executeScript("return window.pageYOffset;");
        util.doCLick(util.searchElement(imgCapacidades));
        System.out.println("Paso 2.\t Nos direcciona en la misma página al contenido del servicio “Capacidades”");
        Thread.sleep(2000);
    ...
    public void CP_007() throws InterruptedException {
        ...
        System.out.println("Verificar el contenido de “Cursos y Certificaciones” del portafolio de servicios ofrecido");
        System.out.println("Pasos para Replicar");
        System.out.println("Paso 1.\t Ubicarnos en el “portafolio de servicios”");
        ...
        System.out.println("Paso 2.\t Vamos al último ítem “Cursos y Certificaciones”");
        ...
        Thread.sleep(2000);
        System.out.println("Paso 4.\t El portal nos direcciona en la misma página al contenido de “Cursos y Certificaciones”");
        assertNotEquals(scrollActual, (long) executor.executeScript("return window.pageYOffset;"));

        System.out.println("Paso 5.\t Al final de la información del ítem “Cursos y Certificaciones” se encuentra habilitado el botón “LEER MÁS”");
        assertTrue(util.elementExists(btnLeerMas));
        Thread.sleep(3000);
        System.out.println("Paso 6.\t Damos clic en el botón “LEER MÁS”");
        util.doCLick(util.searchElement(btnLeerMas));

        System.out.println("Paso 7.\t El sistema nos redirecciona a otra página con el contenido de “Cursos y Certificaciones”.");
